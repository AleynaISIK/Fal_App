...
class FourthViewController: MyController {
...
extension FourthViewController : UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableview_outlet.dequeueReusableCell(withIdentifier: "FourthTableViewCell", for: indexPath) as! FourthTableViewCell
